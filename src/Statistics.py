...
from src.TxtFileWriter import CTxtFileWriter
...
class CStatistics:
    ...
    def hesapla(self):
        ...
        self.IlkBarTarihi = self.Trader.Date[0]
        self.SonBarTarihi = self.Trader.Date[-1]
        ...
        self.GetiriMaxDD = 0.0  #-1.0 * float(Sistem.GetiriMaxDD)
        ...
        self.ProfitFactorSistem = 0.0 #float(Sistem.ProfitFactor)
        ...
        self.GetiriKzSistemYuzde = 0.0
        self.GetiriKzNetSistemYuzde = 0.0
        self.getiri_istatiskleri_hesapla()
        self.assign_to_map()
        return result
    ...
    def text_message(self, Message, MessageColor):
    ...
    def ekran_koordianatlarini_goster(self, PanelNo=1):
        for col in range(20):
            for row in range(10):
                s = f'{col}, {row}'
                self.panel(PanelNo).column(col).row(row)
                s = f'{self.ColNum}, {self.RowNum}'
                self.text_message(s, (255, 215, 0))  # Gold
    ...
    def istatistikleri_ekrana_yaz(self, PanelNo=1):
        ...
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(0).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(3).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(6).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(9).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(12).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(15).row(i).text_message(s, (255, 215, 0))  # Gold
    ...
    def getiri_istatistikleri_ekrana_yaz(self, PanelNo=2):
        ...
        str_list.append(s)
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(ColumnOffset + 1).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        str_list.append(s)
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(ColumnOffset + 2).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        str_list.append(s)
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(ColumnOffset + 3).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        str_list.append(s)
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(ColumnOffset + 4).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        str_list.append(s)
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(ColumnOffset + 5).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        str_list.append(s)
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(ColumnOffset + 6).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        str_list.append(s)
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(ColumnOffset + 7).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        str_list.append(s)
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(ColumnOffset + 8).row(i).text_message(s, (255, 215, 0))  # Gold
        ...
        str_list.append(s)
        for i, s in enumerate(str_list):
            self.panel(PanelNo).column(ColumnOffset + 10).row(i).text_message(s, (255, 215, 0))  # Gold
