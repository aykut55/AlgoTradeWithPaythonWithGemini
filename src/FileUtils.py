...
class CFileUtils:
    ...
    def open_log_file(self, LogFileName, LastUpdatTimeEnabled=True, SummaryEnabled=False):
        if self.LogEnabled and not self.LogFileIsOpened:
            ...
            if self.LogFileIsOpened:
                if LastUpdatTimeEnabled:
                    self.write_last_update_time_to_log_file()
